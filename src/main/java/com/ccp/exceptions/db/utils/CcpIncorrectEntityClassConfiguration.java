...
public class CcpIncorrectEntityClassConfiguration extends RuntimeException{
	
	public CcpIncorrectEntityClassConfiguration(Class<?> configurationClass, IncorrectEntityClassConfigurationType incorrectEntityClassConfigurationType) {
