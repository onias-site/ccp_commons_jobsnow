...
public class CcpErrorDbCrudMultiGetSearchUnfeasible extends RuntimeException{

	public CcpErrorDbCrudMultiGetSearchUnfeasible(Collection<CcpJsonRepresentation> jsons, CcpEntity... entities) {
