...
public class CcpEntityFactory {
	...
	public final CcpEntity2 entityInstance;
	...
	private static CcpEntity2 getMainEntity(Class<?> configurationClass) {
		CcpEntity2 entity = getEntity(configurationClass, mainEntityNameProducer);
		return entity;
	}

	public static CcpEntity2 getEntity(Class<?> configurationClass, Function<Class<?>, String> function) {
		CcpEntityDetails entityDetails = new CcpEntityDetails(configurationClass, function);
		
		CcpEntity2 result = new DefaultImplementationEntity(entityDetails);
