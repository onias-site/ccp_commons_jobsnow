...
class DecoratorAsyncWriterEntity extends CcpEntityDelegator implements CcpDecoratorEntity<CcpEntityAsyncWriter>{
	
	final Class<?>  clazz;
	
	public DecoratorAsyncWriterEntity(CcpEntity2 entity, Class<?> clazz) {
		super(entity);
		this.clazz = clazz;
	}
